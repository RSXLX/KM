...
export function InPlaySidebar({ open, onClose, match }: InPlaySidebarProps) {
  ...
  const panelTransition = 'transition-transform duration-300 [transition-timing-function:cubic-bezier(0.4,0,0.2,1)]';
  const overlayTransition = 'transition-opacity duration-300 [transition-timing-function:cubic-bezier(0.4,0,0.2,1)]';
